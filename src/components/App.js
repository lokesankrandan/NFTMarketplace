...
import BasicNFTAbi from '../contractsData/BasicNFT.json'
import BasicNFTAddress from '../contractsData/BasicNFT-address.json'
...
function App() {
  ...
  const loadContracts = async (signer) => {
    ...
    const nft = new ethers.Contract(BasicNFTAddress.address, BasicNFTAbi.abi, signer)
    setNFT(nft)
    setLoading(false)
  }
